...
public class BookingService {
    ...
    @Transactional // deal with inconsistent data
   ...
   private BookingDto getBookingByNumber(String bookingNumber){
    ...
    private List<BookingDto> getBookingByUserId(Long userId) {
        ...
        return bookings.stream().
                map(booking -> {
                    List<ShowSeat> seats = showSeatRepository.findAll().
                            stream().filter(seat -> seat.getBooking() != null && seat.getBooking().getId()
    ...
    private BookingDto mapToBookingDto(Booking booking,List<ShowSeat> seats){
        ...
        bookingDto.setBookingTime(booking.getBookingTime()); // check point
        ...
        movieDto.setDurationMin(booking.getShow().getMovie().getDurationMin());
